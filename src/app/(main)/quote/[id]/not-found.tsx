    ...
    <section className="flex min-h-[60vh] flex-col items-center justify-center py-20">
      <Container className="text-center">
        ...
        >
          ...
          >
            <span className="text-[8rem] font-bold leading-none tracking-tighter text-primary/10 md:text-[10rem]">
              404
            </span>
            ...
            >
              <FileQuestion className="h-20 w-20 text-primary md:h-24 md:w-24" />
            </motion.div>
          </motion.div>
        </motion.div>
